  ...
  mounted() {
    ...
    const startFireBackdrop = async () => {
      try {
        ...
        const logoEl = document.querySelector("#project-loader-panel .project-shell-logo") ||
                       document.querySelector("#project-loader-stage img");
