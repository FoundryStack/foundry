...
export const EDGE_CATALOG = [
  ...
  },
  {
    ...
    label: 'calls-provider',
    source: 'Provider adapter derivation',
    description: 'Provider module calls an external provider system.',
    colorVar: '--fg-edge-provider',
    colorKey: 'edgeProvider',
    width: 1.5,
    lineStyle: 'dotted',
    marker: 'arrow',
  },
