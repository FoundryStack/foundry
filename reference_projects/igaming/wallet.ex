defmodule IgamingRef.Finance.Wallet do
  ...
  attributes do
    ...
    attribute :balance, :money do
      description "Current balance. Must never go negative — enforced by the SufficientBalance rule on all debit Transfers (RG-MGA-001)."
      allow_nil? false
  ...
  policies do
    ...
    policy action(:debit) do
      description "Debit requires the wallet to be active. Enforced in the action validate — policy layer ensures actor is authorised."
