...
config :foundry_web,
  ...
  default_project_root: Path.expand("../reference_projects/igaming", __DIR__),
...
config :foundry_web, FoundryWeb.Endpoint,
  ...
  pubsub_server: Foundry.PubSub,
  live_view: [signing_salt: "+VbD15HA"]
...
config :esbuild,
  ...
  foundry_web: [
    ...
    cd: Path.expand("../apps/foundry_web/assets", __DIR__),
...
config :tailwind,
  ...
  foundry_web: [
    ...
    cd: Path.expand("../apps/foundry_web", __DIR__)
  ]
